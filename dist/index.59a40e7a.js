...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    form.addEventListener("submit", async (e)=>{
        ...
        if (city) try {
            await (0, _searchBarJs.getWeatherData)(city);
        } catch (error) {
...
},{"9c62938f1dccc73c":"oTetg","aceacb6a4531a9d2":"aozJO"}],"oTetg":[function(require,module,exports) {
"use strict";
...
},{}],"aozJO":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5DdEV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WEATHER_BASE_URL", ()=>WEATHER_BASE_URL);
...
const displayWeather = (data)=>{
  ...
  <div class="weather-info">
    <img src="https://openweathermap.org/img/wn/${data.weather[0].icon}@4x.png" alt="Weather Icon" class="weather-icon" />
    <h2 class="city-name">${data.name}, ${data.sys.country}</h2>
    <p class="temperature">${Math.round(data.main.temp)}\xb0C</p>
